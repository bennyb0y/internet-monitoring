...
## Pre-requisites
Before we get started installing the Prometheus stack. Ensure you install the latest version of docker and [docker-compose](https://docs.docker.com/compose/install/) on your Docker RPI. This has been tested with Docker on Raspberry pi 3+ with raspbian buster. Tuning is needed for RPI4 and RPI zero.
